return {
    ...
    ANNOUNCE_ADVENTUREFAIL = "I forget what started the fighting...",
    ANNOUNCE_BEES = "Nobody's innocent any more.",
    ANNOUNCE_BOOMERANG = "Ow! I should try to catch that!",
    ANNOUNCE_CHARLIE = "You don't know about war.",
    ANNOUNCE_CHARLIE_ATTACK = "Tall folk don't last long round here.",
    ANNOUNCE_COLD = "My ears are always ringing.",
    ANNOUNCE_HOT = "You'd be surprised how quick fur ignites.",
    ANNOUNCE_CRAFTING_FAIL = "I don't have all of the ingredients.",
    ANNOUNCE_DEERCLOPS = "One on three? Best odds yet.",
    ANNOUNCE_DUSK = "I've done things I'm not proud of.",
    ANNOUNCE_EAT =
    {
        GENERIC = "Here you go, little guy.",
        PAINFUL = "Good men die. I choose to live.",
    ...
    ANNOUNCE_ENTER_DARK = "A part of you never leaves the jungle.",
    ANNOUNCE_ENTER_LIGHT = "Coming in hot!",
    ANNOUNCE_FREEDOM = "The war never ends, the battlefield just changes.",
    ANNOUNCE_HIGHRESEARCH = "I feel so smart now!",
    ANNOUNCE_HOUNDS = {"Armed and ready!", "We ain't all makin' it out of here."},
    ANNOUNCE_HUNGRY = {"Lots to do before I punch out.", "Survival ain't pretty."},
    ANNOUNCE_HUNT_BEAST_NEARBY = "They been looking for yours truly.",
    ...
    ANNOUNCE_KNOCKEDOUT = "Need to get patched up!",
    ANNOUNCE_LOWRESEARCH = "I didn't learn very much from that.",
    ANNOUNCE_MOSQUITOS = "Peace is a fairy tale.",
    ...
    ANNOUNCE_QUAKE = "Survive here a week, then you get a name.",
    ANNOUNCE_RESEARCH = "Never stop learning!",
    ANNOUNCE_SHELTER = "I know everything that happens here.",
    ANNOUNCE_THORNS = "Ow!",
    ANNOUNCE_BURNT = "Yikes! That was hot!",
    ANNOUNCE_TORCH_OUT = "Never let your guard down.",
    ANNOUNCE_TRAP_WENT_OFF = "Teemo'd.",
    ANNOUNCE_UNIMPLEMENTED = "OW! I don't think it's ready yet.",
    ANNOUNCE_WORMHOLE = "There's nothing left here.",
    ANNOUNCE_CANFIX = "\nI think I can fix this!",
    ANNOUNCE_ACCOMPLISHMENT = "War didn't change me, I changed war!",
    ...
    ANNOUNCE_WET = "I used to live by a code.",
    ANNOUNCE_WETTER = "One day there'll be a reckoning.",
    ANNOUNCE_SOAKED = "Never. Get. Attached.",
    
    ANNOUNCE_BECOMEGHOST = "I'm the last scout standing.",
    ANNOUNCE_GHOSTDRAIN = "Everyone's on a clock, but only mine keeps ticking.",

    DESCRIBE_SAMECHARACTER = "You can't tell but, uh, I've grown quite the beard under here.",
    ...
    DESCRIBE =
    {
        ...
        RUINSHAT = "Some masks you never take off.",
        NIGHTMARE_TIMEPIECE =
        {
        CALM = "All is well.",
        ...
        ARMORWOOD = "Two and a half seconds is all it takes.",
        ARMOR_SANITY = "Sometimes, time stands still, and all you can do is watch.",
        ASH =
        {
        ...
        BLUE_MUSHROOM =
        {
            GENERIC = "We'll make them pay for what they did to your family little guy.",
            INGROUND = "Face toward enemy.",
            PICKED = "Here you go, little guy. You're my only friend left.",
        },
        BOARDS = "Boards.",
        ...
        DEERCLOPS_EYEBALL = "We all live in the jaws of the beast.",
        ...
        FOOTBALLHAT = "This could have saved a lot of good men.",
        FROG =
        {
        ...
        GREEN_MUSHROOM =
        {
            GENERIC = "You and I are survivors, buddy. They can never kill us.",
            INGROUND = "Got a little surprise for 'em.",
            PICKED = "They won't make the mistake of thinking you're harmless again.",
        },
        ...
        RED_MUSHROOM =
        {
            GENERIC = "Another mushroom, another victim.",
            INGROUND = "There's a mushroom out there with your name on it.",
            PICKED = "There's nothing left here.",
        },
        REEDS =
        {
        ...
        TOPHAT = "Time to put on my killin' hat.",
        ...
        WALRUSHAT = "Next time I see Nashor, I'll yank a couple more.",
        WALRUS_CAMP =
        {
            EMPTY = "Looks like somebody was camping here.",
            GENERIC = "It looks warm and cozy inside.",
        },
        WALRUS_TUSK = "Got teeth? You got a weapon.",
