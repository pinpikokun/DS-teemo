...
configuration_options = {
    ...
    {name = "", label = "Summoner Spells", hover = "", options = {{description = "", data = 0}}, default = 0},
    {
        name = "flash_range",
        label = "Flash Range",
        hover = "Flash blink distance / フラッシュの移動距離",
        options = {
            {description = "1",  data = 1},
            {description = "2",  data = 2},
            {description = "3",  data = 3},
    ...
    {
        name = "flash_cooldown",
        label = "Flash Cooldown",
        hover = "Flash cooldown in minutes / フラッシュのクールダウン（分）",
        options = {
    ...
    {
        name = "ignite_cooldown",
        label = "Ignite Cooldown",
        hover = "Ignite cooldown in minutes / イグナイトのクールダウン（分）",
        options = {
            {description = "1 min", data = 60},
            {description = "2 min", data = 120},
            {description = "3 min", data = 180},
